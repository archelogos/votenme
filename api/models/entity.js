...
function Entity (kind){
  ...
  //     property: value
  //   }
  var fromDatastore = function (obj) {
  ...
  //     }
  //   ]
  var toDatastore = function (obj, nonIndexed) {
  ...
  // if order exits, the query is orderd by that parameter
  this.list = function (limit, token, cb, order) {
    if(!order){
